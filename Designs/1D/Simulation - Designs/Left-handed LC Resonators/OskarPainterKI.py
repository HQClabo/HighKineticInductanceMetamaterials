...
import numpy as np
import gdspy
from Modules.ModuleResonator import unit_cell, ghosts_U, T_feedline_simulation, T_feedline_extended, waveguide_simulation, waveguide_extended_new
...
lib.add(design)
gdspy.LayoutViewer()
lib.write_gds("BIG-waveguide-3um-to-ground-T.gds")
