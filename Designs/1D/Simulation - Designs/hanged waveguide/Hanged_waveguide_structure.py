...
L_spir = 500e-6                       #length of spiral
t_spir = 600e-9                       #width of spiral
...
RightArm1 = gdspy.FlexPath(Twirl_right1,t_spir*1e6, ends = 'extended')#.rotate(np.pi,center=center1)
LeftArm1 = gdspy.FlexPath(Twirl_left1,t_spir*1e6)#.rotate(np.pi,center=center1)
pad1 = gdspy.Rectangle(pad1_corners[0],pad1_corners[1])#.rotate(np.pi,center=center1)
...
#second object: n = 2
# L_spir2 = 1e-3
# Twirl_right2, Twirl_left2,pad2_corners = cs.CompTwirlSpirPad(L_spir2, t_spir, L_couple*1.26, dim_pad1)
...
waveguide, shift = hw.hanged_waveguide(L_feed,w_feed,n,well_size,[top1, spacings_to_feed])
...
lib.add(structure)
lib.write_gds('8PadRes-L600mm.gds')